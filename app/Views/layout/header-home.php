...
<head>
    ...
    <link rel="stylesheet" href="/assets/frontend/css/common-skeleton.min.css?" type="text/css" media="all" />
    <link rel="stylesheet" href="/assets/frontend/css/tooltip.min.css" type="text/css" media="all" />
    <link rel="stylesheet" href="/assets/frontend/css/font-awesome.css" type="text/css" media="all" />
    <link rel="stylesheet" href="/assets/frontend/css/elegant-font.css" type="text/css" media="all" />
    <link rel="stylesheet" href="/assets/frontend/css/style.css" type="text/css" media="all" />
    <link rel="stylesheet" href="/assets/frontend/css/page-builder.css" type="text/css" media="all" />
    <link rel="stylesheet" href="/assets/frontend/plugins/revslider/public/assets/css/rs6.css" type="text/css" media="all" />
    <link rel="stylesheet" href="/assets/frontend/css/style-core.css" type="text/css" media="all" />
    <link rel="stylesheet" href="/assets/frontend/css/kingster-style-custom.css" type="text/css" media="all" />
            ...
            <div class="kingster-mobile-header-container kingster-container clearfix">
                <div class="kingster-logo kingster-item-pdlr kingster-mobile-logo-center">
                    <div class="kingster-logo-inner">
                        <a class="" href="index.html"><img src="/assets/frontend/upload/logo-white.png" alt="" width="200" height="200" title="Teknik Informatika Unusia" /></a>
                    </div>
                </div>
                    ...
                    <div class="kingster-top-bar-container kingster-container">
                        <div class="kingster-top-bar-container-inner clearfix">
                            <div class="kingster-top-bar-left kingster-item-pdlr">
                                <a href="https://unusia.ac.id/" style="margin-right: 30px;">Unusia</a><a href="#" style="margin-right: 30px;">Login</a>
                            </div>
                            <div class="kingster-top-bar-right kingster-item-pdlr">
                                <div class="kingster-top-bar-right-text"><span style="color: #8dd7e5; margin-right: 30px;"></span><a href="#" style="margin-right: 0px;"> Contact us </a></div>
                                <div class="kingster-top-bar-right-social">
                                    <a href="#" target="_blank" class="kingster-top-bar-social-icon" title="email"><i class="fa fa-envelope-open"></i></a>
                                ...
                                <div class="kingster-main-menu" id="kingster-main-menu">
                                    <ul id="menu-main-navigation-1" class="sf-menu">
                                        ...
                                        <li class="menu-itemmenu-item-has-children  kingster-mega-menu">
                                            ...
                                            <div class="sf-mega sf-mega-full" style="background-image: url('/assets/frontend/upload/mega-menu-bg.jpg'); background-position: bottom right; background-repeat: no-repeat;">
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item " data-size="15">
                                                        <div class="kingster-mega-menu-section-content">                    
                                                            <img src="/assets/frontend/upload/menu-logo.png" style="margin-bottom: 13px;" alt="" /><br />
                                                            <span style="font-size: 14px; font-weight: 500;">Jl. Taman Amir Hamzah No.5 Pegangsaan, Menteng, Jakarta Pusat</span>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
